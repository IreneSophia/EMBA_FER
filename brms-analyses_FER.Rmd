...
The visual angle of the faces was approximately `r round(vis_ang(c(800,1000))[1],2)` degrees wide and `r round(vis_ang(c(800,1000))[2],2)` degrees high, depending on the exact frame.
