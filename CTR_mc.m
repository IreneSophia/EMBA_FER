function CTR_mc(opt, xCenter, yCenter, window, black, grey)
...
DrawFormattedText(window,... % the first input to drawing functions is almost always the window variable
    'Affe',... % the second input to DrawFormattedText() is the text we want to draw
...
DrawFormattedText(window, 'Hund', xCenter - 200, yCenter, black); 
DrawFormattedText(window, 'Katze', xCenter + 50, yCenter, black); 
DrawFormattedText(window, 'Löwe', xCenter + 300, yCenter, black); 
